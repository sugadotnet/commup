...
namespace APPBASE.Models
{
    ...
    {
        private List<ProductVM> oVMProduct;

        //Construction 1
        public ProductstockVM() { }
        //Construction 2
        public ProductstockVM(List<ProductVM> poViewModel) {
            oVMProduct = poViewModel;
        }
        ...
        public List<ProductstockVM> LIST_INDEX { get; set; }
    } //End public partial class ProductstockVM

    public partial class Productstock_indexVM
    {
        public int? ID { get; set; }
        public int? PROD_ID { get; set; }
        public string PROD_CODE { get; set; }
