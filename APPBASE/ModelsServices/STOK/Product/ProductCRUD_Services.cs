...
namespace APPBASE.Models
{
    public class ProductCRUD
    {
        ...
        //Constructor
        public ProductCRUD() { } //End public ProductCRUD()
        public void Create(ProductVM poViewModel)
        {
            try
            {
        ...
        public void Update(ProductVM poViewModel)
        {
            try
            {
                using (var db = new DBMAINContext())
                {
                    Product oModel = db.Products.AsNoTracking().SingleOrDefault(fld => fld.ID == poViewModel.ID);
                    //Map Form Data
                    oModel.InjectFrom(poViewModel);
                    //Set Field Header
        ...
        public void Delete(int? id)
        {
            try
            {
                using (var db = new DBMAINContext())
                {
                    Product oModel = db.Products.Find(id);
                    db.Products.Remove(oModel);
                    db.SaveChanges();
                    this.ID = oModel.ID;
                } //End using
            } //End try
        ...
        public void Create(List<ProductVM> poViewModel)
        {
            try
            {
