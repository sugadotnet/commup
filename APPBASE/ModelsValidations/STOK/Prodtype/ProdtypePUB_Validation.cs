...
{
    public partial class Prodtype_Validation
    {
        private ProdtypeVM oViewModel;
        private ProdtypeDS oDS = new ProdtypeDS();
        public List<ValidationMSG_VM> aValidationMSG = new List<ValidationMSG_VM>();

        //Constructor
        public Prodtype_Validation(ProdtypeVM poViewModel)
        {
            oViewModel = poViewModel;
        } //End public Prodtype_Validation()
    ...
    } //End public partial class Prodtype_Validation
