...
{
    public partial class Countrycode_Validation
    {
        private CountrycodeVM oViewModel;
        private CountrycodeDS oDS = new CountrycodeDS();
        public List<ValidationMSG_VM> aValidationMSG = new List<ValidationMSG_VM>();

        //Constructor
        public Countrycode_Validation(CountrycodeVM poViewModel)
        {
            oViewModel = poViewModel;
        } //End public Countrycode_Validation()
    ...
    } //End public partial class Countrycode_Validation
