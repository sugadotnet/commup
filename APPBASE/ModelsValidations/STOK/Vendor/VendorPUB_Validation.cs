...
{
    public partial class Vendor_Validation
    {
        private VendorVM oViewModel;
        private VendorDS oDS = new VendorDS();
        public List<ValidationMSG_VM> aValidationMSG = new List<ValidationMSG_VM>();

        //Constructor
        public Vendor_Validation(VendorVM poViewModel)
        {
            oViewModel = poViewModel;
        } //End public Vendor_Validation()
    ...
    } //End public partial class Vendor_Validation
