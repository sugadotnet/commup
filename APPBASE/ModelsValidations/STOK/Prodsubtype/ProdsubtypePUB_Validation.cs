...
{
    public partial class Prodsubtype_Validation
    {
        private ProdsubtypeVM oViewModel;
        private ProdsubtypeDS oDS = new ProdsubtypeDS();
        public List<ValidationMSG_VM> aValidationMSG = new List<ValidationMSG_VM>();

        //Constructor
        public Prodsubtype_Validation(ProdsubtypeVM poViewModel)
        {
            oViewModel = poViewModel;
        } //End public Prodsubtype_Validation()
    ...
    } //End public partial class Prodsubtype_Validation
