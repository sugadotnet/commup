...
{
    public partial class Serial_Validation
    {
        private SerialVM oViewModel;
        private SerialDS oDS = new SerialDS();
        public List<ValidationMSG_VM> aValidationMSG = new List<ValidationMSG_VM>();

        //Constructor
        public Serial_Validation(SerialVM poViewModel)
        {
            oViewModel = poViewModel;
        } //End public Serial_Validation()
    ...
    } //End public partial class Serial_Validation
