...
{
    public partial class UkuranController : Controller
    {
        [HttpPost]
        public ActionResult Create(UkuranVM poViewModel)
        {

            oVAL = new Ukuran_Validation(poViewModel);
        ...
        [HttpPost]
        public ActionResult Edit(UkuranVM poViewModel)
        {
            oVAL = new Ukuran_Validation(poViewModel);
            oVAL.Validate_Edit();
    ...
    } //End public partial class UkuranController : Controller
