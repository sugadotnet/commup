...
{
    public partial class CountrycodeController : Controller
    {
        [HttpPost]
        public ActionResult Create(CountrycodeVM poViewModel)
        {

            oVAL = new Countrycode_Validation(poViewModel);
        ...
        [HttpPost]
        public ActionResult Edit(CountrycodeVM poViewModel)
        {
            oVAL = new Countrycode_Validation(poViewModel);
            oVAL.Validate_Edit();
    ...
    } //End public partial class CountrycodeController : Controller
