...
namespace APPBASE.Controllers
{
    ...
    public partial class SerialController : Controller
    {
        private DBMAINContext db = new DBMAINContext();
        private SerialDS oDS = new SerialDS();
        private SerialCRUD oCRUD = new SerialCRUD();
        private Serial_Validation oVAL;
        //DATA
        ...
        public JsonResult Index_json(int? id = null)
        {
            ...
            {
                this.oDataLookup.results.Add(new Select2_detailVM { id = item.ID, text = item.SERIAL_NAME });
            } //end loop
    ...
    } //End public partial class SerialController : Controller
