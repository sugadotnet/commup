...
namespace APPBASE.Controllers
{
    ...
    {
        [HttpPost]
        public ActionResult Create(VendorVM poViewModel)
        {

            oVAL = new Vendor_Validation(poViewModel);
        ...
        [HttpPost]
        public ActionResult Edit(VendorVM poViewModel)
        {
            oVAL = new Vendor_Validation(poViewModel);
            oVAL.Validate_Edit();
    ...
    } //End public partial class VendorController : Controller
