...
namespace APPBASE.Controllers
{
    ...
    public partial class ProdsubtypeController : Controller
    {
        private DBMAINContext db = new DBMAINContext();
        private ProdsubtypeDS oDS = new ProdsubtypeDS();
        private ProdsubtypeCRUD oCRUD = new ProdsubtypeCRUD();
        private Prodsubtype_Validation oVAL;
        ...
        public JsonResult Index_json(int? id = null)
        {
            ...
            foreach (var item in oData) {
                this.oDataLookup.results.Add(new Select2_detailVM { id = item.ID, text = item.PRODSUBTYPE_NAME });
            } //end loop
    ...
    } //End public partial class ProdsubtypeController : Controller
